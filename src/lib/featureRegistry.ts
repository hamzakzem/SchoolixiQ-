...
const STAFF_PERMISSION_LABELS: Record<string, { labelAr: string; labelEn: string }> = {
  ...
  staff: { labelAr: 'إدارة حسابات الكادر', labelEn: 'Staff Management' },
  tuition: { labelAr: 'الأقساط المدرسية', labelEn: 'Tuition' },
  behavior: { labelAr: 'السلوك والتبليغات', labelEn: 'Behavior' },
  attendance: { labelAr: 'الحضور والغياب', labelEn: 'Attendance' },
  grades: { labelAr: 'الدرجات والشهادات', labelEn: 'Grades & Certificates' },
  ...
  announcements: { labelAr: 'الإعلانات والتبليغات', labelEn: 'Announcements' },
  ...
  id_cards: { labelAr: 'هويات الطلاب', labelEn: 'Student ID Cards' },
