      ...
      <AnimatePresence>
        {isSidebarOpen && (
          <motion.div
            ...
            className="fixed inset-0 bg-slate-900/50 backdrop-blur-sm z-[var(--sx-z-drawer-backdrop)] lg:hidden"
          />
        )}
      </AnimatePresence>
